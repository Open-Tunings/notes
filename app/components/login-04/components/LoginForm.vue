...
import { Field, FieldLabel, FieldSeparator, FieldDescription, FieldGroup } from '@/components/ui/field';
import { Input } from '@/components/ui/input';

// Props and events
const props = defineProps({ class: String, loading: Boolean, error: null });
    ...
    <Card class="overflow-hidden p-0">
      <CardContent class="grid p-0 md:grid-cols-2">
        <form @submit.prevent="handleSubmit" class="p-6 md:p-8">
          <FieldGroup>
            ...
            <Field>
              ...
              <Input v-model="credentials.email" id="email" type="email" placeholder="m@example.com" required />
            </Field>
            ...
            <p v-if="props.error" class="text-red-500 mt-2 text-center">
        ...
        <div class="bg-muted relative hidden md:block">
          <img src="/guitar2.jpg" alt="Image" class="absolute inset-0 h-full w-full object-cover">
        </div>
      </CardContent>
    </Card>
  </div>
